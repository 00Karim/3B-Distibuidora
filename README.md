...
### 📦 Instalación y ejecucion (Docker)

### 1. Clonar repositorio

```bash
git clone https://github.com/tuUsuario/3B-Distribuidora.git
```
...
### 1. Una vez clonado -- > Instalar y ejecutar backend
...
https://kaki-3702995.postman.co/workspace/Kaki's-Workspace~8f77d75b-549a-47a0-8779-3fa4655c0207/collection/45187142-1229c918-ae99-45d8-baf4-b59d02e1412f?action=share&creator=45187142&active-environment=45187142-b3125180-39bc-4d2f-b29b-9f6291467339
Ejecutar todas las pruebas juntas con un delay de 20ms
